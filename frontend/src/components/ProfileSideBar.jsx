...
const ProfileSideBar = ({user, seti}) => {
  ...
  return (
    <aside className="fixed z-40 top-15 md:static w-full h-15 md:w-[26%] md:h-full px-5 md:pt-5 text-slate-300 md:border-r md:border-t md:border-slate-500 bg-[var(--profile-sidebar-bg)] flex md:flex-col items-center gap-8 overflow-x-scroll">

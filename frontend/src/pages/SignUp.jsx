...
const SignUp = () => {
  ...
  return (
    <div className="relative">
      ...
      <div ref={mainRef} className="w-screen absolute z-10 pt-10 flex justify-center items-center">
        <form ref={formRef} onSubmit={handleSubmit} className="w-11/12 h-9/12 p-4 sm:max-w-125 box-border flex flex-col gap-3 rounded-2xl shadow-2xl">
